...
public class ExprRelacional extends NodoAST {
    private final NodoAST operandoIzquierdo;
    private final String operador;
    private final NodoAST operandoDerecho;

    public ExprRelacional(NodoAST operandoIzquierdo, String operador, NodoAST operandoDerecho, int linea, int columna) {
        super(linea, columna);
    ...
    public <T> T accept(LatinusAstVisitor<T> visitor) {
        return visitor.visitExprRelacional(this);
    }
}
